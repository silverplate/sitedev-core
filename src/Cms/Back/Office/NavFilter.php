...
abstract class \Core\Cms\Back\Office_NavFilter
{
    protected $_class;
    protected $_type;
    protected $_page;
    ...
    /**
     * @var array[\App\Cms\Back\Office_NavFilter_Element]
     */
    protected $_elements;
    ...
    public function addElement(\Core\Cms\Back\Office_NavFilter_Element $_el)
    {
        $this->_elements[] = $_el;
    }
