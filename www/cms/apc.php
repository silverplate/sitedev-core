...
h1.apc b.logo, h1.apc b.nameinfo { display: block; }

h1.apc b.logo span.logo {
	background:rgb(119,123,180);
	color:black;
...
h1.apc b.logo span.name { color:white; font-size:0.7em; padding:0 0.8em 0 2em; }
h1.apc b.nameinfo { color:white; display:inline; font-size:0.4em; margin-left: 3em; }
...
<div class="head">
	<h1 class="apc">
		<b class="logo"><span class="logo"><a href="http://pecl.php.net/package/APC">APC</a></span></b>
		<b class="nameinfo">Opcode Cache</b>
	</h1>
	<div class="login">
	<?php put_login_link(); ?>
	</div>
